...
function SetPassword() {
  ...
  useEffect(() => {
    if (!token) setError('Ссылка активации недействительна')
  }, [token])
    ...
    return (
      <div className="set-password-container success">
        <div className="set-password-box">
          ...
          <p className="success-message">Теперь вы можете войти в систему с вашим юзернеймом и паролем.</p>
          <p className="set-password-subtitle">Переход на главную через {countdown}...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="set-password-container">
      <div className="set-password-box">
        ...
        <p className="set-password-subtitle">Вы получили эту ссылку после одобрения вашей заявки на креаторство</p>
        ...
        <form onSubmit={handleSubmit} className="set-password-form">
          <div className="form-group">
            ...
            <input type="password" id="password" value={password}
              ...
              required className="form-input" placeholder="Введите пароль (минимум 6 символов)" />
          </div>
          <div className="form-group">
            <label htmlFor="confirmPassword">Подтвердите пароль *</label>
            <input type="password" id="confirmPassword" value={confirmPassword}
              onChange={e => setConfirmPassword(e.target.value)}
              required className="form-input" placeholder="Повторите пароль" />
          </div>
