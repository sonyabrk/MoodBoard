    ...
    <section className="admin-section">
      <div className="admin-container">
        ...
        <div className="admin-buttons">
          <button className="admin-btn admin-btn--project" onClick={() => setShowProjectModal(true)}>
            <span className="admin-btn__dot" />
            о проекте
          </button>
          <button className="admin-btn admin-btn--creator" onClick={() => setShowCreatorModal(true)}>
            <span className="admin-btn__dot" />
      ...
      <CreatorFormModal isOpen={showCreatorModal} onClose={() => setShowCreatorModal(false)} />
    </section>
  )
}
